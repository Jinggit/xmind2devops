...
class TestStep(object):
    ...
    def __init__(self, step_number=1, actions='', testcasedata='', expectedresults='', execution_type=1, result=0):
        """
        TestStep
        :param step_number: test step number
        :param actions: test step actions
        :param testcasedata: test data
    ...
    def to_dict(self):
        data = {
            ...
            'testcasedata': self.testcasedata,
